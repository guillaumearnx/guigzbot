...
module.exports = {
    ...
    options: [{type: 4, name: "ip", description: "Adresse IP a étudier", required: true}],
                ...
                res.on('end', async () => {
                    ...
                    if (data.status !== 'success') {
                        ...
                        return await interaction.reply({
                            content: "Impossible de continuer avec cette IP !", embeds: [e], ephemeral: true
                        });
                    }
                    ...
                    c.addField("Informations", `◉ IP : ${data.query}
